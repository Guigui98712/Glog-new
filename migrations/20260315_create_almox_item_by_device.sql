-- Cria RPC para cadastro de item via dispositivo do almoxarife (acesso publico).
-- SECURITY DEFINER permite gravar com validacao do dispositivo ativo.
...
begin
  ...
  if v_quantidade > 0 then
    ...
    perform public.almox_adjust_item_quantity(v_item.id, v_quantidade);
    v_item.quantidade := v_quantidade;
  end if;
